...
export const TICK_ALARM_NAME = "siqshift-tick";
export const RULES_REFRESH_ALARM_NAME = "siqshift-rules-refresh";
export const RECONNECT_ALARM_NAME = "siqshift-reconnect";
export const SPAN_ADVANCE_ALARM_NAME = "siqshift-span-advance";
